...
<?php
  ...
  function entryRequirementsDisplayString($section = '') {
    ...
    if ($section == '') {
      ...
      $trailerText = 'of the Entry Information page';
    }
...
<title>Sans Souci Festival of Dance Cinema - <?php echo $currentYearString;?> Email Signup</title> 
...
//        $textLeader = ($dataItemWasUpdated) ? "*\t" : "\t";
  ...
  class SSFEntryForm {
    ...
    static public $displayDataStructures = 1; // 2/15/14
    ...
    static public $debugStateVariablesAtBottom = 1; // 2/15/14
    static public $debugStateVariablesAtTop = 1; // 2/15/14
    ...
    private function initState($fromArray) {
      ...
      // creatingNewPerson is always true for email signup. 2/15/14
...
<!-- begin FORM ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- -->
      ...
      <form name="entryForm" id="entryForm" style="border:none 1px pink;" onSubmit="return preSubmitValidation();" action="entryForm2013.php" method="post">
...
echo '              <td align="center" valign="middle" class="bodyTextWithEmphasisOnBlack">' . "\r\n";
        if ($showBlurb) echo '<div class="bodyTextOnBlack" style="text-align:left;padding:0px 54px 24px 54px;">Sans '
                 ...
                 . ' credentials and affiliations. Accepted works will be screened ' 
                 . SSFRunTimeValues::getEventDatesDescriptionStringLong(SSFRunTimeValues::getAssociatedEventId($theForm->callForEntriesId))
                 . ' in Boulder, Colorado, USA.<br><br>For more information see our <a href="http://sanssoucifest.org/' . $danceCinemaCallFilename . '">'
//                 . 'Call for Entries</a> and our <a href="http://sanssoucifest.org/onlineEntryForm/' . $entryRequirementsInWindowFilename . '">' . $currentYearString 
//                 . ' Entry Information</a>.</div>' . "\r\n";
...
<!--        <input type="hidden" id="userLoginUnderway" name="userLoginUnderway" value="<?php echo $theForm->state['userLoginUnderway']; ?>" > -->
        <input type="hidden" id="userLoginUnderway" name="userLoginUnderway" value="0" >  <!-- 2/15/14 -->
