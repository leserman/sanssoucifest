...
*/
  ...
  String.prototype.getEmailAddressFromLine = function() { 
    var pattern=new RegExp(/From:.*$/i); // Get everything from < through >
    var searchResults = pattern.exec(this);
    if (searchResults !== null) return searchResults[0].replace(/From:/ig,"").trim(); // Strip < and >
    else return "";
  }

  String.prototype.getEmailAddress = function() {
    $addr = this.getEmailAddressFromAngleBrackets();
