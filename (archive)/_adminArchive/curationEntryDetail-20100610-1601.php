<?php
  ...
  $workIdToSave = (isset($_GET['workId'])) ? $_GET['workId'] : 0;
  $updateCurationData = (isset($_GET['updateCurationData']) && ($_GET['updateCurationData'] == 'YES'));
  
/* Moved to curationDbUpdate.php
...
/* OBSOLETE
  ...
  // updateCurationData is set in saveCuratorDataJS() in ssf.js to trigger this condition
...
*/
  ...
  if ($updateCurationData && ($workIdToSave != 0)) {
...
<!-- display Entry Details -->
            ...
            <div class="bodyTextOnDarkGrayRowPadded" style="border:0px pink dashed;">
<?php 
/* TODO: Fix emailWasSent so it can be used here.
              $acceptanceDisplay = (HTMLGen::emailWasSent($workRow) 
                                 ? HTMLGen::acceptanceDisplay($workRow['workId'], $workRow['accepted'], $workRow['rejected'])
...
//              $acceptanceDisplay = str_replace('|', "\'", $arDisplay);
              ...
              echo "<span style='font-size: 16px;color:#B7E5F7;'>"
                ...
                .  $acceptanceDisplay
                . "</span><span id='entryScoreSpan' style='padding-right:1.5em;color:#DF7416'>" . substr(HTMLGen::getDbScoreFor($workRow['workId']), 0, 3) 
...
?>
              <div style="border:0px yellow dashed;">
...
<?php
      ...
      $displayLinePart2 = HTMLGen::getMediaReceivedDisplayElement($workRow['dateMediaReceived']);
        echo '<div style="margin-top:2px;">' 
          . $displayLinePart1 . '<div class="floatRight" style="padding-top:0px;padding-right:4px;">' 
...
// Display Media Information
    $floatLeftDivs = array(HTMLGen::getMediaFormatsDisplayElement($workRow['submissionFormat'], $workRow['originalFormat']),
                           HTMLGen::getFrameParametersDisplayElement($workRow),
...
//    echo "<div style='margin-top:2px;'>";
//    HTMLGen::displayFrameParameters($workRow);
//    echo "</div>";
...
// Display the Rest of the Entry Information
  ...
  if ($alwaysShow || (isset($previouslyShownAt) && ($previouslyShownAt != ''))) echo '<div style="margin-top:1px;">' . HTMLGen::getSimpleDataWithDescriptionLine('Also shown at', $previouslyShownAt) . '</div>';
  if ($alwaysShow || (isset($submissionNotes) && ($submissionNotes != ''))) echo '<div style="margin-top:2px;">' . HTMLGen::getSimpleDataWithDescriptionLine('Submission notes', $submissionNotes) . '</div>';
...
<div class="bodyTextOnDarkGray" style="border:0px red dashed;">
  <form action="curationEntry.php" method="post" name="curationData" id="curationData">
    <div>
...
<?php 
  function displayCurationControlsFor($workId, $personId, $personNickname, $widgets) {
    $scoreSelectorIdName = "score-" . $personId;
    $notesTextAreaIdName = "notes-" . $personId;
    echo "        <tr>\r\n";
  ...
  foreach ($curatorRows as $curatorRow) {
    displayCurationControlsFor($workRow['workId'], $curatorRow['curator'], $curatorRow['nickName'], $widgets);
  }
  echo '<tr><td align="center" colspan="4"><hr noshade="true" size="1" width="90%" style="color:#FFFFCC">' . "</td></tr>\r\n";
  echo "<tr><td align='center' colspan='4'><div style='margin-left:100px;'>";
  $disable = false;
...
//  echo "        </td></tr>\r\n";
  echo '        <div align="right" valign="middle" class="bodyTextOnDarkGray" colspan="4">';
