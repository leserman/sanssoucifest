...
//  echo phpinfo();
  ...
  $editorState = $_POST;
  SSFDebug::globalDebugger()->belch('050. _POST', $_POST, 1);
...
<?php
  ...
  HTMLGen::addTextWidgetRowWithTitleWidth('Response Sent', 'dateSentStr', $dateSentStr, 16);
?>
