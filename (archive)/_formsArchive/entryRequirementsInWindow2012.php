...
<title>Sans Souci Festival of Dance Cinema - <?php echo $currentYearString; ?> Entry Information</title> <!-- TODO get year from DB -->
          ...
          <tr>
            <td colspan="2" align="left" valign="middle">
              <div  class="programPageTitleText" style="margin:8px 0 6px 0;"><?php echo $currentYearString;?> Entry Information</div>
			    ...
			    <tr>
				    <td align="left" valign="top" colspan="2"><div class="smallBodyTextOnBlack" style="text-align:right;padding:0px 10px 4px 6px;"><a href="#entryForm" 
...
<?php $highlightTextColor = '#e4afe4'; //FAFF66 E495E4 ?>
  Read the Vimeo <a href="http://vimeo.com/help/compression" target="vimeo">compression guidelines</a> to ensure that you submit a high quality rendition. Aside from specifying codec, frame rate, data rate, resolution, and audio, the page has links to brief informative tutorials for over three dozen editing and compression applications including, for example, iMovie, Final Cut Pro, Adobe Premier, Avid Media Composer, and Sorenson Squeeze.<br><br>
      There are a variety of Vimeo &quot;Settings&quot; that you can manage. <span style="color: <?php echo $highlightTextColor; ?> ";>Be sure to check the box to &quot;Allow other people to download the source video&quot; (<a href="./vimeoDownloadabilityInfo.php">detailed instructions</a>).</span>  Choose password-protected if you like - just make sure you tell us the password on your Sans Souci online entry form.
				    <br><br>
				    Using Vimeo is a new approach for us and we welcome your <a href="mailto:feedback@sanssoucifest.org">feedback</a>. Our hope is that this approach relieves you from making a reliable DVD, paying postage, and having your package get lost or delayed in transit. It also allows us to accept HD submissions on a regular basis for the first time.
            </td>
          </tr>
			    <tr style="margin-top:8px;margin-bottom:12px;">
				    <td align="left" valign="top" class="entryRequirementsText"><a name="deadlines">4.&nbsp;</td>
				  ...
				  <tr>
				    <td></td>
				    <td>
						  <table width="80%" align="left" border="0" cellspacing="1" cellpadding="1" style="padding:6px 0 0 40px">
							  <tr valign="bottom">
							  ...
							  <tr valign="middle">
								  <td align="left" class="bodyTextOnBlack">Early: <?php echo date('l, M j, Y', strtotime(SSFRunTimeValues::getEarlyDeadlineDateString())); ?></td>
								  <td align="center" class="bodyTextOnBlack">$<?php echo SSFRunTimeValues::getEarlyDeadlineFeeString(); ?></td>
							  </tr>
							  <tr valign="middle">
								  <td align="left" class="bodyTextOnBlack">Final: <?php echo date('l, M j, Y', strtotime(SSFRunTimeValues::getFinalDeadlineDateString())); ?></td>
								  <td align="center" class="bodyTextOnBlack">$<?php echo SSFRunTimeValues::getFinalDeadlineFeeString(); ?></td>
							  </tr>
						  </table>
				    </td>
				  </tr>
				  <tr>
				    <td></td>
					  <td align="left" valign="top" class="entryRequirementsText">Make your check or money order (in US Dollars drawn on a US bank) payable to Sans Souci Festival of Dance Cinema OR pay via PayPal from the <a href="#entryForm" onClick="if (window.opener && window.opener.name=='EntryFormWindow') { window.opener.focus(); } else { history.back(); }">entry form</a>.
            ...
            <td align="left" valign="top" class="entryRequirementsText"><span style="color:#FFFF66">Still Images.</span> We publish a program for each of our shows on our website. For example, see <a href="http://sanssoucifest.org/programPages/programAtlas2011.php" target="vimeo">our 2011 event</a>. For this we need a small selection of representative still images with your submission. Screen captures are preferred but publicity photos may be accepted. Please include photo credit information on the entry form for production or publicity photos only; we will assume that the images are screen captures unless you specify a photo credit.<br><br>
              <span style="color:#FFFF66">About Digital Images:</span> Production and publicity photos should be submitted at 300 dpi. Screen captures should have the same pixel dimensions as your movie frame. Please provide all images in square pixels such that the image appears in the same aspect ratio as your frame. They may be submitted via email to <a href='mailto:images@sanssoucifest.org'>images@sanssoucifest.org</a> or via a web address which links directly to the image(s) and which you specify on the online entry form.
			    ...
			    <tr>
				    <td align="left" valign="top" colspan="2"><div class="smallBodyTextOnBlack" style="text-align:right;padding:8px 10px 4px 6px;"><a href="javascript:void(0)" onClick="if (window.opener && window.opener.name=='EntryFormWindow') { window.opener.focus(); } else { history.back(); }">back | go to Online Entry Form</a>
				        <div style="color:#FFFF66;font-size:16px;font-weight:normal;text-align:left">Further Information</div></div>
				    </td>
			    </tr>
				  <tr>
