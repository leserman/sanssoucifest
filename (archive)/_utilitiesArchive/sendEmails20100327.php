...
// Class mailer
  class mailer {
    ...
    private static function initInfo() {
      ...
      self::$plainTextPartTemplate = file_get_contents("../../private/emailTemplates/callText20100329.txt", "r");
      $fileContents = file_get_contents("../../private/emailTemplates/callHTML20100329.txt", "r");
    ...
    private static function sendEmail($person, $index) {
      ...
      self::$debugger->becho('', sprintf("%03d", $index) . ' ' . date("Y-m-d H:i:s") . ' &quot;' 
                              . $person["name"] . '&quot;' . $printEmailAddresses . ' ' . $sentString . ', ' . $savedString, 1);
