// databaseSupportFunctions.js
  ...
  function openCurationEmailTextWindowX(entryId) {
...
//    xmlHttpObject.open("POST", "../bin/database/entryDetail.php");
//    xmlHttpObject.send("workId=" + workIdValue);
    xmlHttpObject.open("GET", "../bin/database/entryDetail.php?workId=" + workIdValue);
  ...
  function changeEntryState(valuePairsString) {
    if (xmlHttpObject == null) xmlHttpObject = getXmlHttpObject2();
    xmlHttpObject.onreadystatechange = displayEntryDetailData;
    xmlHttpObject.open("GET", "../bin/database/entryDetail.php?" + valuePairsString);
    xmlHttpObject.send(null);
  }
