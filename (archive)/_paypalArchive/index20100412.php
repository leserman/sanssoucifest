...
<?php
  echo '                                <tr>';
  echo '                                  <td colspan="2" align="center" valign="middle"><input name="submit" align="middle" type="image" style="margin:20px 0 20px 0;" ';
  if (!SSFRunTimeValues::earlyDeadlineHasPassed()) { // early deadline
    // TODO Move button names from being hard-coded to the callForEntries table and get from SSFRunTimeValues.
    echo 'src="../images/PayEntryFeeNowButton25Early.gif" alt="Use PayPal to Pay the $' . $entryFeeString . ' USD Early Entry Fee Now">';
  } else { // after early deadline
    echo 'src="../images/PayEntryFeeNowButton40.gif" alt="Use PayPal to Pay the $' . $entryFeeString . ' USD Entry Fee Now">';
  }
  echo '                                  </td>';
  echo '                                </tr>';
?>
...
<?php
  ...
  else echo 'For us to consider your work for our 2010 showings, ';
  echo 'both your payment <em>and</em> your media materials must arrive by ';
  $deadlineDateParts = explode('-', $deadlineDateString);
