...
<title>Sans Souci Festival of Dance Cinema - 2009 Entry Form</title>
...
function initPopup() {
  ...
  else if (ie4) popupBox=document.all.dek.style;
...
function popup(msg,bak){
  var content="<TABLE WIDTH='240' BORDER='1' BORDERCOLOR='black' CELLPADDING='2' CELLSPACING='0' BGCOLOR='"+bak+
              "'><TR><TD ALIGN=left class='medSmallBodyTextLeaded'>"+msg+"<\/TD><\/TR><\/TABLE>";
...
&nbsp;</td></tr>
          <tr>
            <td colspan="3" align="left" valign="middle" class="programPageTitleText"><img src="../images/dotClear.gif" alt="" width="1" height="6" 
              ...
              Official Entry Form, 2009 (CLOSED)<br>
          ...
          <tr align="left">
            <td height="10" colspan="3" valign="top"  class="bodyTextOnBlack" style="padding:6px 4px 6px 4px;">Sans Souci,
              ...
              credentials and affiliations. Accepted works will be screened Friday &amp; Saturday, March 20th &amp; 21st, 2009
							in Boulder, Colorado, USA.<br>
							<br>
							To make a submission, complete this form and adhere
<!--              to the <a href="entryRequirements2009.html">requirements</a>. You may return later to print or edit this form -->
<!--              to the <a href="javascript:void(0)" onClick="if (!entryRequirementsWindow) { entryRequirementsWindow=window.open('entryRequirementsInWindow2009.html', -->
              to the <a href="javascript:void(0)" onClick="entryRequirementsWindow=window.open('entryRequirementsInWindow2009.html',
...
<!--
                  ...
                  the <a href="../PDF-EntryForms/SansSouci2009EntryForm01.pdf">PDF paper one</a>.)
-->                  
              <br clear="all">
                ...
                <tr align="left" valign="middle">
                  <td colspan="2"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
										...
										<tr align="left" valign="middle">
											...
											</span><span class="smallBodyTextOnBlack">&nbsp;&nbsp;&nbsp;<a href="javascript:window.void(0)" onMouseOver="popup('What are Other Roles? Examples of other roles are: Additional Editing, Camera, Camera & Editing, Cinematography, Dance Improvisation, Artistic Associate, Funding Source, Improvisational Dance, Videography, and Visual Creations.','#FFFF99')" 
												onMouseOut="killPopup()" onClick="window.alert('Examples of other roles are: Additional Editing, Camera, Camera & Editing, Cinematography, Dance Improvisation, Artistic Associate, Funding Source, Improvisational Dance, Videography, and Visual Creations.')">What's 
												this?</a></span></td>
										</tr>
										<tr align="left" valign="middle">
                ...
                <tr align="left" valign="middle">
                  <td colspan="2" class="medSmallBodyTextLeadedOnBlack">By clicking the Submit Button below, you certify that you hold
                    all necessary rights for the submission of this entry. Clicking Submit on this entry form gives Sans Souci Festival 
										permission for screening this submission at the Dairy Center for the Arts in Boulder Colorado USA on March 20 &amp; 21, 2009 and also:
									</td>
                </tr>
                <tr align="left" valign="middle">
                  <td align="left" colspan="2" class="entryFormField"><table width="96%"  border="0" align="center" cellpadding="2" cellspacing="0">
                    <tr><!-- FIX RE-INITIALIZATION OF Permission RADIO BUTTONS -->
                      <td align="right" valign="top"><input type="radio" name="Permission" id="allOK" value="allOK2009" 
                      <?php if ($_SESSION["Permission"]!="askMe2009") echo "checked"; ?> ></td>
                      <td align="left" valign="top" style="padding-top:4px;"><label for="allOK" class="entryFormRadioButton">All tours 
                          associated with the 2009 Season in the
                          US and elsewhere. (Sans Souci has previously toured in Mexico, Germany, and Trinidad.)</label></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top"><input type="radio" name="Permission" id="askMe" value="askMe2009"
                        <?php if ($_SESSION["Permission"]=="askMe2009") echo "checked"; ?>></td>
