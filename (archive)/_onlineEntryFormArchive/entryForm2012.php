...
<?php 
  ...
  = '<a href="javascript:void(0)" onClick="entryRequirementsWindow=window.open(\'' . $entryRequirementsInWindowFilename . '\','  
  ...
  class phoneHome {
    ...
    public static function personInfoHelper($stateArray, $leaderString) {
      ...
      foreach ($dataItemNames as $dataItemName) {
        ...
        $text = self::addDataItem($dataItemName, $dataValue); 
...
<!-- begin FORM ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- -->
      ...
      <form name="entryForm" id="entryForm" style="border:none 1px pink;" onSubmit="return preSubmitValidation();" action="entryForm2012.php" method="post">
...
// TODO: Pull the event date and venue description from the DB and compute the filenames for entryRequirementsInWindow2012.php and 
//       danceCinemaCall2012.php from runTimeValues.currentYearString.
  if ($showBlurb) echo '<div class="bodyTextOnBlack" style="text-align:left;padding:0px 54px 24px 54px;">Sans '
                 ...
                 . ' in Boulder, Colorado, USA.<br><br>For more information see our <a href="http://sanssoucifest.org/danceCinemaCall2012.php">Call for Entries</a> and our <a href="http://sanssoucifest.org/onlineEntryForm/entryRequirementsInWindow2012.php">2012 Entry Information</a>.</div>' . "\r\n";
...
//    HTMLGen::addPixelDimensionsWidgetsRow($dbPersonWorkState['frameWidthInPixels'], $dbPersonWorkState['frameHeightInPixels'], $disable);
    ...
    HTMLGen::addTextWidgetRow(SSFHelp::getHTMLIconFor('photoLocation') . 'Photos Web Addr', DatumProperties::getItemKeyFor('works', 'photoLocation'), $dbPersonWorkState['photoLocation'], 256, $disable);
...
if ($theForm->isDisplayingData() && $theForm->atLeastOneWorkExistsForThisCallAndPerson) {
  ...
  $submitYourVideoString = '<span style="color:' . $highlightTextColor . '";>Remember to submit your video at <a href="http://vimeo.com">Vimeo</a></span> '
                         ...
                         . '<a href="http://sanssoucifest.org/onlineEntryForm/entryRequirementsInWindow2012.php#media">Media</a> '
                         . 'section of the Entry Information page.)';
  ...
  $lastWordString = 'If you have questions after reading the ' . $entryRequirementsDisplayString
