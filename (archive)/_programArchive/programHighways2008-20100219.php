...
<body bgcolor="#FFFFFF" text="#000000" link="#0033FF" vlink="#0033FF" alink="#990000">
  ...
  <tr>
    <td colspan="3" align="left" valign="middle" class="programPageTitleText"><img src="../images/dotClear.gif" alt="" width="1" height="12" hspace="0" vspace="0" border="0" align="middle"><br>
      <span style="color:#E63333;">Highways Program, 2008</span><br>
    </td>
  </tr>
	<tr>
...
-->
		      Friday &amp; Saturday, October 3rd &amp; 4th, 2008 at 8:30 pm<br>
  </tr>
...
<?php
  ...
  function displayShowIndex($showArray) {
		echo '<tr align="left">';
		echo '<td align="center" colspan="3" class="bodyTextOnBlack" style="text-size=6px;padding:20px 0 32px 0;">|';
    ...
    echo '  <tr>' . "\r\n";
    echo '    <td align="center" valign="top"><img class="borderPic08H" src="' . $imageDirectory . $imageFileName . '" alt="' . $imageAltText 
