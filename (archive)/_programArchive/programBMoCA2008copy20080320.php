...
<!-- 		  <img src="images/bmocalogo_outline_yellow1.gif" alt="Boulder Museum of Contemporary Art" longdesc="http://bmoca.org"><br clear="all"> -->
		  ...
		  Friday &amp; Saturday, April 4th &amp; 5th, 2008, 8:00 pm<br>
	...
	<tr>
		<td colspan="3" align="center" valign="middle"><hr class="horizontalSeparator1"></td>
	</tr>
	<tr>
		<td colspan="3" align="center" valign="middle" class="bodyTextLeadedOnBlack">
			<p style="margin-top=8px;margin-bottom:10px;color:#FFFF99">Video installations will be on view from <b>7:00 - 8:00 each evening.</b><br>
				Screenings of shorts and live dance performance begins at <b>8:00 each evening.</b><br>
				Belgian dance/documentary (75 min) will screen at <b>5:00 on Saturday only</b>.</p>
			<p style="margin-bottom:10px;color:#FFFF99">$12 general admission, $8 for museum members, seniors and students<br>
				Tickets can be purchased on-line at bmoca.org, at the museum,<br>or by calling visitor services at 303.443.2122.</p>
		</td>
	</tr>
	<tr>
		<td colspan="3" align="center" valign="middle"><hr class="horizontalSeparator1"></td>
...
<?php
	include '../database/databaseSupportFunctions.php';
    ...
    echo '  <tr>' . "\r\n";
    echo '    <td align="center" valign="top"><img src="images/Stills2008/' . $imageFileName . '" alt="' . $imageAltText 
              . '" title="' . $imageAltText . '" height="' . $imageHeightInPixels . '" "width="180" hspace="2" vspace="2" border="2" align="left">';
