...
<?php
  ...
  function displayShowIndex($showArray) {
	...
	function displayDescription($showId, $text) {
		echo '<tr align="left">' . "\r\n";
		echo '	<td height="10" colspan="3" valign="top"  class="programInfoText"><a name="' . HTMLGen::genShowIdTag($showId) . '"></a>' . $text . '<br clear="all">' . "\r\n";
    ...
    echo '  <tr>' . "\r\n";
    echo '    <td align="center" valign="top"><img class="borderPic08B" src="../images/Stills2008/' . $imageFileName . '" alt="' . $imageAltText 
              . '" title="' . $imageAltText . '" height="' . $imageHeightInPixels . ' "width="180" hspace="2" vspace="2" border="1" align="left">';
