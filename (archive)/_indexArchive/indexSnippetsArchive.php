...
<!-- 2014 Upcoming Program, Guatemala -->
                      <tr>
                        <td align="center" valign="middle" class="programInfoText" style="padding-top:0px;">
                          <div class="hideLinkUnderline">
                            <div class="homeHeading1" style="margin-top:28px;margin-bottom:0px;">Upcoming Program</div>
                            <!-- event list Upcoming Programs  -->
                            <!-- Guatemala 2014 -->
                            ...
                            <div style="font-size:20px;margin-top:2px;margin-bottom:0px;color:#FFFF99;font-weight:normal;line-height:1.3;"><a href="http://sanssoucifest.org/programPages/programGuatemala2014.php">Universidad de San Carlos de Guatemala</a><br>
...
<!-- 2014 Call for Entries -->
                    <tr>
                      <td align="center" valign="middle">
                        ...
                        <div class="callForEntriesText" style="text-align:center;">Sans Souci Festival of Dance Cinema invites submissions of<br>works that integrate dance and cinematography<br>for exhibition in Boulder, Colorado, USA <br><?php echo $eventDatesDescriptionString;?>.</div>
                        <div class="homeHeading1" style="margin-top:8px;margin-bottom:-4px;font-size:18px;">Call for Entries Closed on May 23, 2014</div>
<!--
...
-->
<!--                        <div class="callForEntriesText"style="text-align:center;margin-top:0;padding-top:5;"><a href="./danceCinemaCall2014.php">Read more</a></div> -->
                           </td>
                    </tr>
<!--
                      <tr>
                        <td align="center" valign="middle">
                          <div class="homeHeading1" style="margin-top:22px;margin-bottom:6px;">
                            Call for Entries
                          </div>
                          <div class="bodyTextLeadedOnBlack" style="text-align:center;">
                            Our next Call for Entries will be published in the Spring of 2014.<br>
                            If you'd like to be notified, please <a href="mailto:mailme@sanssoucifest.org?subject=Add%20me%20to%20your%20email%20list&amp;body=Edit%20below%20as%20appropriate.%0A%0AAdd%20me%20to%20your%20email%20list%20for%20Events.%0A%0AAdd%20me%20to%20your%20email%20list%20for%20Calls%20for%20Entries.%0A%0ARemove%20me%20from%20your%20email%20list.%0A%0A">join our mailing list</a>.<br>
                            A summary of our <a href="#danceCinemaDefinition">Curatorial Criteria</a> is below.
                          </div>
                        </td>
                      </tr>
-->
<!-- Boulder, Auf-Sept 2012 with postcard on the home page -->                 
                    <tr>
                      <td align="center" valign="middle" class="programInfoText" style="padding-top:0px;">
