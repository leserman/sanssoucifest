...
*/
    ...
    public function arMarkupEmailListOnSend() {
      ...
      self::$debugger->bechoTrace('arMarkupEmailListOnSend script', $script, -1);
      echo $script;
    }
    ...
    public function insertIntoDatabase($adminUserId_Parameter_DO_NOT_USE=0) {
      ...
      if (count($this->potentiallyReferencedWorks) > 0) {
        ...
        $commInsertString = "INSERT INTO communications (recipient, template, sent, dateSent, type, sender, referencedWork, contentText, "
                           ...
                           . SSFQuery::quote($this->subject()) . ", NOW(), " 
                           . $adminUserId . ", NOW(), " . $adminUserId . ", NOW(), " . $adminUserId . ")";
        //SSFDB::debugNextQuery();
...
// MediaReceipt Communique "subclass"
    ...
    private function newMediaReceivedMessageBody() {
      ...
      if ($worksCount > 0) {
        ...
        // TODO Get $year from RunTimeValues.
        $year = '2011';
        $message .= 'to the ' . $year . ' Sans Souci Festival of Dance Cinema. We have received the media for ';
    ...
    */
    ...
    private function newAcceptRejectMessageBody($requestClipPermission=true, $inviteFeedbackRequest=false) {
      ...
      if ($totalNumberOfWorks == 0) {
        ...
        if (($numberOfAcceptedWorks > 0) && ($this->venueDirections() != '')) $message .= "<br><br>" . $this->venueDirections();
