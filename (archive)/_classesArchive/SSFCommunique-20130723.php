...
//      self::$adminUserId = isset($args[0]) ? $args[0] : 0; // NOW INGNORING userId parameter.
    ...
    private function generateMessage() {
      $message = '';
      switch ($this->commType) {
        case 'AcceptReject': $message = $this->newAcceptRejectMessageBody(); break; // Assigned into $this->message prior to 7/20/13
        case 'MediaReceipt': $message = $this->newMediaReceivedMessageBody(); break; // Assigned into $this->message prior to 7/20/13
        default: self::$debugger->belchTrace('INTERNAL ERROR. Bad commType in Communique::generateMessage. Tell David.', $this->commType, 1);
      }
      return $message;
    }
