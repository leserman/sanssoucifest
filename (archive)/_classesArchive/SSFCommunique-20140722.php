...
//    public function workId() { return $this->potentiallyReferencedWorks[0]['workId']; }
    ...
    public function setValuesFromDataArray($dataArray) {
      ...
      self::$debugger->belch("48 setValuesFromDataArray() dataArray", $dataArray, -1); // turned on for SMTP debug 6/18/14
...
//      echo "message: " . $message . "<br>";
      ...
      self::$debugger->belch('send() this', $this, -1); // turned on for SMTP debug 6/18/14
      self::$debugger->belch('send() mail', $mail, -1); // turned on for SMTP debug 6/18/14
    ...
    */
    ...
    private static function computedRequestForClipPermissionFor($work) {
      ...
      if ($workAccepted) {
        ...
        if (SSFRunTimeValues::getCallForEntriesId() == 14) { // 2014 call
