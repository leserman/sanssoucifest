...
//    SSFDB::debugNextQuery();
  ...
  public static function displayAdministratorSelector($adminSelector, $rowStyle, $titleTextClass, $onChangeText, $managementElementId='hostAdminId') {
    ...
    echo "              <div>\r\n";
    //SSFDB::debugNextQuery();  
    $setAdminCookieText = 'setCookie("ssf_hostAdminId", this.value);';
    $setAdminCookieText .= 'setCookie("ssf_' . $managementElementId . '", this.value);';
//    $setAdminCookieText = "alert(this.value);";
    $personRows = SSFQuery::getAdministrators();
//    echo "                <select id='adminSelector' name='adminSelector' style='width:220px' onchange='" . $onChangeText . "'>\r\n";
    ...
    $adminId = (isset($_COOKIE['ssf_hostAdminId']) && ($_COOKIE['ssf_hostAdminId'] != 0)) ? $_COOKIE['ssf_hostAdminId'] : SSFRunTimeValues::getDefaultAdministratorId();
    self::debugger()->becho('adminId', $adminId, 1);
    self::debugger()->becho('adminSelector', $adminSelector, 1);
...
//    HTMLGen::displaySelectionOptions($selectionOptions, $adminId);
//    HTMLGen::displaySelectionOptions($selectionOptions, "<script type='text/javascript'>document.write(getCookie('ssf_hostAdminId'));</script>");
    HTMLGen::displaySelectionOptions($selectionOptions, $adminSelector);
    echo "                </select>\r\n";
    echo "              </div>\r\n";
    echo "            </div>\r\n";
    echo "            <div style='clear:both;'></div>\r\n";
    echo "          </div>\r\n";
    //setcookie('ssf_hostAdminId', $adminSelector);
//    echo "          <script type='text/javascript'>setCookie('ssf_hostAdminId', '" . $adminSelector . "');</script>\r\n";
//    echo "          <script type='text/javascript'>setCookie('ssf_" . $managementElementId . "', '" . $adminSelector . "');</script>\r\n";
    echo "    <!-- Administrator Selector -->\r\n";
...
//      echo "<div>\r\n" . self::getMediaReceivedDisplayElement($workArray['dateMediaReceived']) . "\r\n<div style='clear:both;'></div>\r\n</div>\r\n";
  ...
  public static function getMediaReceivedDisplayElement($dateMediaReceived, $dateMediaPostmarked='0000-00-00') {
    ...
    if (!self::mediaReceived($dateMediaReceived)) 
      ...
      $displayString .= self::getSimpleDataWithDescriptionElement('; picked up', $dateMediaReceived);
    }
