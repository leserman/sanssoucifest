...
class SSFWebPageAssets2 {
  ...
  public static function getNavBar($moveUpString = '../') {
    ...
    $navBarString .= self::$indent . '  <div class="navBar"><a target="_top" href="' . $moveUpString . 'index.php">Home</a></div>' . PHP_EOL;
    ...
    $navBarString .= self::$indent . '  <div class="navBar" style="margin:4px 6px -2px 0;"><a target="_top" title="find us on Facebook" href="http://www.facebook.com/sanssoucifest/"><img alt="follow me on facebook" src="//login.create.net/images/icons/user/facebook_30x30.png" style="border:0;"></a></div>' . PHP_EOL;
    
    $navBarString .= self::$indent . '  <div class="navBar" style="margin:6px 6px -2px 0;"><a href="https://www.fracturedatlas.org/site/fiscal/profile?id=8028" target="_top"><img src="' . $moveUpString . '/images/donateNowAtFracturedAtlas3.png" width="88" height="70" style="border:0;" alt="Donate now!"></a></div>' . PHP_EOL;
...
*/
  ...
  public static function displayAdminNavBar($moveUpString = '../') {
    echo '<div class="narBarMainSection">' . PHP_EOL;
    echo '  <div class="navBar"><a target="_top" href="' . $moveUpString . 'index.php">SSF Home</a></div>' . PHP_EOL;
    echo '</div>' . PHP_EOL;
    echo '<div class="narBarArchiveSection">' . PHP_EOL;
    echo '  <div><div class="navBarTitle1">Administration</div>' . PHP_EOL;
    echo '    <div class="navBar"><a target="_top" href="' . $moveUpString . 'admin/index.php">Admin Home</a></div>' . PHP_EOL;
    echo '  </div>' . PHP_EOL;
    echo '  <div><div class="navBarTitle2">Admin Activities</div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'admin/adminDataEntry.php">Manage<br>People &amp; Works</a></div>' . PHP_EOL;
    echo '    <div style="line-height:1px;margin:3px auto;border-top:#666 thin solid;width:50%;"></div>';
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'admin/submissionsOverviewReport.php">Track Submissions</a></div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'admin/informArtistsOfMediaReceipt.php">Acknowledge Media Rceipt</a></div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'admin/adminPaypalParse.php">Paypal Payments</a></div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'admin/paymentsReport.php">Track Payments</a></div>' . PHP_EOL;
    echo '    <div style="line-height:1px;margin:3px auto;border-top:#666 thin solid;width:50%;"></div>';
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'admin/curationData.php">Curate</a></div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'admin/viewCurationProgress.php">Curation History</a></div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'admin/curationEmail.php">Send Curation Results Email</a></div>' . PHP_EOL; // was curationAccRejEmail
    echo '    <div style="line-height:1px;margin:3px auto 2px auto;border-top:#666 thin solid;width:50%;"></div>';
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'admin/adminPermissions.php">Manage Permissions</a></div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'admin/adminShowOrder.php">Program Shows</a></div>' . PHP_EOL;
//    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'admin/showShowOrder.php">Show Shows</a></div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'admin/projectionistReport.php">Projectionist</a></div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'admin/manageMedia.php">Manage Media</a></div>' . PHP_EOL;
/*
    echo '  </div>' . PHP_EOL;
    echo '  <div><div class="navBarTitle2">Admin Reports</div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'admin/paymentsReport.php">Track Payments</a></div>' . PHP_EOL;
    echo '  </div>' . PHP_EOL;
    echo '  <div><div class="navBarTitle2">Admin Utilities</div>' . PHP_EOL; 
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'admin/permissionReponses.php">Manage Permissions</a></div>' . PHP_EOL;
    echo '  </div>' . PHP_EOL;
*/
    echo '  <div><div class="navBarTitle2">Admin Help</div>' . PHP_EOL; 
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'admin/adminFAQs.php">FAQs</a></div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'admin/adminHowTo.php">How To</a></div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'admin/adminEmailCheck.php">Email addr in DB?</a></div>' . PHP_EOL;
    echo '  </div>' . PHP_EOL;
    echo '  <div><div class="navBarTitle2">Interactive Utilities</div>' . PHP_EOL; 
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'bin/utilities/checkDBIntegrity.php">Chk DB Integrity</a></div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'bin/utilities/repairDuplicatePeople.php">Repair Dup Pple</a></div>' . PHP_EOL;
    echo '  </div>' . PHP_EOL;
    echo '  <div><div class="navBarTitle2">1-Click Utilities</div>' . PHP_EOL; 
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'bin/utilities/populateColumnsSchemaInfoCache.php">Gen Meta Table</a></div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'bin/utilities/genFileNames.php">Gen File Names</a></div>' . PHP_EOL;
//    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'bin/utilities/createEmptyCurationRows.php">Init Curation</a></div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'bin/utilities/populateImageTable.php">Updt Image Tbls</a></div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'bin/utilities/updateMetadataFromVimeo.php">Vimeo Metadata</a></div>' . PHP_EOL;
//    echo '    <div class="navBarTight"><a target="_top" href="#">Set RT Values</a></div>' . PHP_EOL;
    echo '  </div>' . PHP_EOL;
    echo '  <div><div class="navBarTitle2">Developer Info</div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'bin/testDrivers/testSSFRunTimeValues.php">Run Time Values</a></div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'bin/testDrivers/dataPropertiesTestDriver.php">Sets &amp; Enums</a></div>' . PHP_EOL;
    echo '  </div>' . PHP_EOL;
    echo '</div>' . PHP_EOL;
/*
    echo '  <div><div class="navBarTitle2">Developer<br>Test Drivers</div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'bin/testDrivers/testWorkDisplay.php">Work Display</a></div>' . PHP_EOL;
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'bin/testDrivers/testText.php">Test Text</a></div>' . PHP_EOL;
    echo '  </div>' . PHP_EOL;
*/
    echo '</div>' . PHP_EOL;
