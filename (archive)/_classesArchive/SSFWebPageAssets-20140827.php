...
class SSFWebPageAssets {
  ...
  public static function displayNavBar($moveUpString = '../') {
    ...
    echo '  <div class="navBar" style="margin:4px 6px -2px 0;"><a target="_top" title="find us on Facebook" href="http://www.facebook.com/sanssoucifest/"><img alt="follow me on facebook" src="//login.create.net/images/icons/user/facebook_30x30.png" border=0></a></div>' . "\r\n";
    
    echo '  <div class="navBar" style="margin:6px 6px -2px 0;"><a href="https://www.fracturedatlas.org/site/fiscal/profile?id=8028" target="_top"><img src="' . $moveUpString . '/images/donateNowAtFracturedAtlas3.png" width="88" height="70" border="0" alt="Donate now!"></a></div>' . "\r\n";
...
//    echo '    <div class="bodyTextOnBlack navBarTight" style="font-size:13px;padding-bottom:1px;">Boulder 2014</a></div>' . "\r\n";
//    echo '    <div style="border-bottom:gray 1px solid;line-height:2px;width:75%;margin-bottom:4px;"></div>' . "\r\n";
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'programPages/programAtlas2014.php">Atlas Black Box</a></div>' . "\r\n";
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'programPages/programBoe2014.php">The Boe</a></div>' . "\r\n";
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'programPages/programBPL2014.php">Canyon Theater</a></div>' . "\r\n";
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'programPages/programUrsinus2014.php">Ursinus College</a></div>' . "\r\n";
//    echo '    <div style="border-bottom:gray 1px solid;line-height:2px;width:75%;margin-bottom:4px;"></div>' . "\r\n";
    echo '  </div>' . "\r\n";
    ...
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'programPages/programOverview2013.php">Boulder 2013</a></div>' . "\r\n";
//    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'programPages/program2013FallDates.php">Boulder Fall \'13</a></div>' . "\r\n";
//    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'programPages/programAtlas2013.php">Atlas 2013</a></div>' . "\r\n";
    ...
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'programPages/programGuatemala2014.php">Guatemala \'14</a></div>' . "\r\n";
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'programPages/programAtticRep2014.php">San Antonio \'14</a></div>' . "\r\n";
    echo '    <div class="navBarTight"><a target="_top" href="' . $moveUpString . 'programPages/programRoxy2014.php">Missoula 2014</a></div>' . "\r\n";
...
*/
  ...
  public static function getCopyrightLine($onWhite = false) {
    $spanClass = "smallBodyTextLeadedGrayLight";
    if ($onWhite) $spanClass = "smallBodyTextLeaded";
    return '<span class="' . $spanClass . '">Copyright ' . self::copyrightYears() 
         . ' Sans Souci Festival of Dance Cinema </span>'
         . '<span class="smallBodyTextLeaded">&#8226; <a href="mailto:' . self::contactEmailAddress() . '">email us</a></span>'
         .  "\r\n";
  }
