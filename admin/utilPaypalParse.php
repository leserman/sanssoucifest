...
<!-- This works in conjuction with Mail, Applescript SSFPaypalPaymentNotificationEmail.scpt, and Safari. -->
...
//  $userPasteInstruction = "Paste email body here.";
  ...
  $inputInfo = isset($_GET['info']) ? $_GET['info'] : 'no info';
  SSFDebug::globalDebugger()->belch("_GET[info]", (isset($_GET['info']) ? $_GET['info'] : 'not set'), -1);
  $cookedInputInfo0 = str_replace("[HASH]", '#', $inputInfo);
  $cookedInputInfo1 = str_replace("[EOL]", PHP_EOL, $cookedInputInfo0);
//  $cookedInputInfo2 = str_replace("%09", '\t', $cookedInputInfo1);
//  $cookedInputInfo3 = str_replace("%20", "^", $cookedInputInfo2);
  $userPasteInstruction = $cookedInputInfo1;
  SSFDebug::globalDebugger()->belch("cookedInputInfo1", $cookedInputInfo1, -1);
...
<form name='emailAnalysisForm' id='emailAnalysisForm' action='utilPaypalParse.php' method='post'>
