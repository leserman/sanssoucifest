...
//    HTMLGen::addPixelDimensionsWidgetsRow($dbPersonWorkState['frameWidthInPixels'], $dbPersonWorkState['frameHeightInPixels'], $disable);
    ...
    HTMLGen::addTextWidgetRow(SSFHelp::getHTMLIconFor('photoURL') . 'Photos Web Addr', DatumProperties::getItemKeyFor('works', 'photoURL'), $dbPersonWorkState['photoURL'], 256, $disable);
