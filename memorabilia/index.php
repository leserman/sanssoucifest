...
-->
          ...
          <article  id="<?php echo $articleId; ?>">
            ...
            <style type="text/css" scoped>
              .page article a:link, .page article a:visited { color: #CCBD99; text-decoration: underline; }
              .page article a:hover { color: #bd0425; text-decoration: none; }
              .pageArea .contentArea { background-color:#333333; margin-left:10px; padding-left:31px; }
