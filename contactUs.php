...
?>
          <article id="contactUs">
            ...
            <style type="text/css" scoped>
              article p { margin-top:20px;font-size:16px;line-height:130%;color:#771655; }
            ...
            <h1 style="color:#771655">Contact Us</h1>
...
?>
              <section id="joinEmail">
                <h2 style="color:#771655;text-align:left;font-size:22px;margin-bottom:15px;">Join an email list</h2>

              <div class="centered leftJustifiedText" style="width:430px;"> <!-- 3/9/15 Experimented with class transbox and abandoned it. -->
                <p>Click one of the links below to manage a subscription to our email lists.</p>
                <p style="margin-top:8px;margin-left:20px;line-height:150%;">
