...
//           .   "onclick='updateARStatus($workId, 0, 1, \"" . self::acceptanceString2(0,1) . "\")'><span style='font-size:1.25em;'>$r</span></a>"
  ...
  public static function progPageDisplayShowIndex($showArray, $comingSoonText='Coming Soon...', $center=false, $multiLine=false, $noPadding=false) {
    ...
    echo '<td align="' . $align . '" colspan="3" class="bodyTextOnBlack" style="padding:' . $padding . ';line-height:130%;">';
  ...
  public static function progPageDisplayNoDescription($height=20) {
    echo '<tr align="left">' . "\r\n";
    echo '  <td height="' . $height . '" colspan="3" valign="top"  class="programInfoText"></td>' . "\r\n";
    echo '</tr>' . "\r\n";
    //echo '<tr><td colspan="3" height="36" align="center" valign="top" class="bodyText">&nbsp;</td></tr>' . "\r\n";
  }
...
*/
    ...
    if ($suppressOriginalFormat) // KLUDGE
      echo '      ' . $filmInfoDivSpanText . $synopsisTitle . '</span>' . '<span style="font-style:italic;line-height:140%;">' . HTMLGen::htmlEncode($synopsis) . "</span>"
                    . (($cityStateCountry != '') ? '<span class="filmCityStateCountryText" style="font-style:normal;"> (' . HTMLGen::htmlEncode($cityStateCountry) . ')</span>' : '')
                    . '</div></td>' . "\r\n";
    else
      echo '      ' . $filmInfoDivSpanText . $synopsisTitle . '</span>' . '<span style="font-style:normal;">' . HTMLGen::htmlEncode($synopsis) . "</span>"
