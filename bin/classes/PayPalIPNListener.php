...
class PayPalIPNListener {
    ...
    protected function curlPost($encoded_data) {
        ...
        // curl options set at https://github.com/Quixotix/PHP-PayPal-IPN/blob/master/ipnlistener.php only
...
//            header('Allow: POST', true, 405);
            throw new Exception("Invalid HTTP request method: " . $_SERVER['REQUEST_METHOD']);
        }
    }
}
?>
