...
<title>Sans Souci Festival of Dance Cinema - Atlas 2011 Program</title>
<style type="text/css">
<!--
.programHighlightColor {color: #e49548; } /* 666 */
...
<!--            <td width="805" align="center" valign="top"> -->
  ...
  <tr>
    <td colspan="3" align="left" valign="middle" class="programPageTitleText"><img src="../images/dotClear.gif" alt="" width="1" height="12" hspace="0" vspace="0" border="0" align="middle"><br>
      <span class="programHighlightColor">Atlas Program, 2011</span><br>
    </td>
  </tr>
	<tr>
...
<!-- http://www.eventbrite.com/ -->
		  ...
		  <div style="font-size:20px;margin-top:8px;">Friday &amp; Saturday, September 16 &amp; 17, 2011</div>
<!--		  <div class="programInfoTextSmall" style="margin-top:6px;font-weight:normal;font-size:15px;"><a href="http://sanssouci2011.eventbrite.com">Reserve your seat</a> or make a donation.</div> -->
<!--
...
<!--		  <div class="programHighlightColor" style="margin:20px 0 0px 0;text-align:center;"></div> -->
<!--
...
?>
  ...
  <tr><td colspan="3">
    <div class="bodyTextOnBlack" style="font-size:18px;margin:10px 0 28px 0;padding-right:40px;text-align:center;color:#FFFF99;"><span style="font-size:20px;">Also see our </span><a href="./programBPL2011.php">October Boulder Pulbic Library</a><span style="font-size:20px;"> Program.</span>
    </div>
  </td></tr>

  <tr><td colspan="3" align="center">
    <div  class="bodyTextLeadedOnBlack" style="padding:0;padding-right:40px;margin:2px auto 30px auto;width:30em;">
      <span class="programInfoTextSmall" style="font-weight:normal;font-size:15px;color:#FFFF99;">This 8th Annual Festival is sponsored by</span><br>
...
<!--
  <tr><td colspan="3">
    <div class="bodyTextOnBlack" style="margin:4px 0 32px;">NOTES:
      <ul>
        <li class="bodyTextOnBlack" style="margin:4px 0 0px 0;">Day and order of videos as posted here will change and does not reflect program order.</li>
        <li class="bodyTextOnBlack" style="margin:4px 0 0px 0;">This year, Sans Souci is also exhibiting 
          short films and documentaries at the Boulder Pulbic Library in October. <a href="./programBPL2011.php">View the Boulder Pulbic Library program</a>.</li>
      </ul>
    </div>
  </td></tr>
-->
