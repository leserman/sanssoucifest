...
?>
            <div style="margin:0 auto;text-align:center;">
              ...
              <div>
                ...
                <!-- Postcard -->
                <div>
                    <div class="bodyText" style="margin:18px 0 0 0;">
                  ...
                  <!-- postcard caption -->
                  <div class="bodyText" style="margin:3px 0;">
                    <div class="bodyText" style="font-size:14px;margin:6px 0 0 0;padding:0;line-height:130%;">
                ...
                <div class="venueText" style="font-size:21px;padding:28px 0 16px 0;">Program Synopsis</div>
                ...
                <div>
                  ...
                  <p class="secondaryTextColor dodeco" style="margin-bottom:3px;">Different <a href="programPages/programAtlas2013.php">programs</a> each evening</p>
                  ...
                  <div class="bodyText" style="padding:0;padding-right:0px;margin:4px auto 0px auto;width:30em;font-size:14px;line-height:130%;">
                ...
                <!-- Boedecker at Dairy -->
                <div>
                  <div id="oct" class="venueText" style="margin:36px 0 0px 0;font-weight:bold;font-size:18px;">
                    ...
                    <span class="dodeco" style="font-size:14px;font-weight:normal;">Different <a href="programPages/program2013FallDates.php">programs</a> on each date</span><br>
                  </div>
