              ...
              <div style="margin-top:13px;">
                ...
                <div id="dec">
                  ...
                  <div class="fundingInfo" style="padding:0;">with support from and in partnership with 
                    <a href="http://www.artsresource.org/dance-bridge/">Dance Bridge</a> &amp; <a href="http://bplnow.boulderlibrary.org/event/movies">Boulder Public Library Cinema Program</a>
                  </div>
                  <div 
                </div>
          		  <div class="fundingInfo" style="padding:0;padding-top:20px;vertical-align:middle;">All with support from <a href="http://www.artsresource.org/bac/"><img src="images/logos/BAC_High_Horizontal1_logo_156x35.jpg" style="width:156px;height:35px;margin:0px 3px 0 3px;vertical-align:middle;"></a>an agency of the Boulder City Council.</div>
              </div>
            </div>
<?php
