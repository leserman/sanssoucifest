          ...
          <article id="suppporters">
            ...
            <section>
              ...
              <p>
                ...
                <a href="http://www.artsresource.org/"><img src="images/logos/BAC-Low_Horizontal2.gif" style="width:200px;height:45px;margin:15px 0 0 0;border:none;vertical-align:top" 
            ...
            <section>
              <h2 id="venues">Venues</h2>
						  ...
						  <p><span class="yearsAtVenue">2004&ndash;2008: </span><a href="http://www.bmoca.org/">Boulder Museum of Contemporary Art, BMoCA</a>, originally called the Boulder Arts Center, was founded in 1972 to showcase and promote the visual arts in Boulder, Colorado. The museum is committed to providing local 
                and regional artists, as well as recognized artists, 	with a significant venue. It is housed in an historic warehouse that now includes three galleries 
                and a 100-seat black box theater. BMoCA hosted Sans Souci in the years 2004 through 2008.
              </p>
